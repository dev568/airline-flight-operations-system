...
import com.airline.crew.filter.CorrelationIdFilter;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleCrewMemberNotFoundException(
    ...
    public ResponseEntity<ErrorResponse> handleDataIntegrityViolationException(
        ...
        if (ex.getMessage() != null) {
            if (ex.getMessage().contains("employee_id")) {
